...
public class GerenciadorDeSessaoTest {
	...
	@Test
	public void garantrQueNaoDevePermitirSessoesTerminandoDentroDoHorarioDeUmaSessaoJaExistente () {
		Filme filme = new Filme();
		filme.setDuracao(120);
		LocalTime horario = LocalTime.now();
	...
	public void garanteQueDevePermitirUmaInsercaoEntreDoisFilmes() {
		...
		Assert.assertTrue(gerenciador.cabe(new Sessao(LocalTime.parse("13:00:00"), filme2, 
				sala)));
	}
}
